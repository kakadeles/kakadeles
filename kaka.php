...
echo color("red","| github: kakadeles |\n");
echo color("red","| fanspage :kakadeles|\n");
echo color("red","| Creator : kakadeles.com          |\n");
...
// function change(){
        ...
        $messageboba10 = fetch_value($021120a,'"message":"','"');
        ...
        $messageboba19 = fetch_value($021120A,'"message":"','"');
